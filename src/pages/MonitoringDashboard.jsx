...
export default function MonitoringDashboardPage() {
  ...
  useEffect(() => {
    ...
    // Fetch exam details
    fetch(`https://codeguard-server-side-1.onrender.com/api/rooms/${roomId}/exam-details`)
      .then((res) => res.json())
      .then((data) => {
    ...
    fetch(`https://codeguard-server-side-1.onrender.com/api/rooms/${roomId}/question`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleUploadQuestion = async () => {
    ...
    try {
      const response = await axios.post(
        `https://codeguard-server-side-1.onrender.com/api/rooms/${roomId}/question`,
        formData,
        {
          headers: {
  ...
  const startExam = async () => {
    try {
      if (examDetails) {
        await fetch(`https://codeguard-server-side-1.onrender.com/api/rooms/${roomId}/exam-details`, {
          method: 'PUT',
      ...
      const response = await fetch(`https://codeguard-server-side-1.onrender.com/api/rooms/${roomId}/question`);
      const data = await response.json();
  ...
  const handleExportAttendance = async () => {
    try {
      const response = await fetch(`https://codeguard-server-side-1.onrender.com/api/rooms/${roomId}/attendance/export`);
