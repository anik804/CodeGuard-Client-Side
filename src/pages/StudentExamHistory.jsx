...
async function fetchExamHistoryApi(studentId, page, limit) {
  const url = `${API_BASE_URL}/api/exam-history/student?studentId=${encodeURIComponent(
    studentId
...
export default function StudentExamHistory() {
  ...
  const {
    ...
    queryKey: ["studentExamHistory", studentId, page],
    queryFn: () => fetchExamHistoryApi(studentId, page, PAGE_LIMIT),
    enabled: !!studentId,
                  ...
                  >
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t">
                        <Badge variant={exam.submitted ? "default" : "outline"}>
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded ${
                    num === page
                      ...
                      : "bg-transparent text-muted-foreground border border-gray-200"
                  }`}
                >
                  {num}
                </button>
            ...
            <div className="space-y-4 mt-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="font-semibold">
                    {selectedExam.examinerName ||
                      selectedExam.examinerUsername ||
                      "Unknown"}
                  </p>
                </div>
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="font-semibold text-2xl">
                    {selectedExam.totalStudentsJoined || 0}
                  </p>
                </div>
                ...
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <p className="font-semibold text-2xl">
                    {selectedExam.submissionsCount || 0}
                  </p>
                </div>
              ...
              {selectedExam.examStartedAt && (
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {new Date(selectedExam.examStartedAt).toLocaleString()}
                    </span>
                  </div>
                </div>
              )}
              ...
              {selectedExam.examEndedAt && (
                <div className="p-4 bg-muted/50 rounded-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4" />
                    <span>
                      {new Date(selectedExam.examEndedAt).toLocaleString()}
                    </span>
                  </div>
                </div>
              )}
