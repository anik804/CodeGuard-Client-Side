  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        navigate(isScheduled ? '/examiner-dashboard' : `/monitoring/${roomId.replace(/\s+/g, '-').toLowerCase()}`);
      }
    } catch (error) {
        ...
        <CardContent className="px-6 py-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1">
              <Label htmlFor="examName" className="flex items-center gap-2 font-medium">
              ...
              <Input
                ...
                className="bg-secondary/50 rounded-lg shadow-sm focus:ring-2 focus:ring-primary transition"
                value={examName}
            ...
            {/* Room ID */}
            <div className="space-y-1">
              <Label htmlFor="roomId" className="flex items-center gap-2 font-medium">
                <FileText className="w-4 h-4 text-primary" />
                Room ID *
              </Label>
              <Input
                ...
                className="bg-secondary/50 rounded-lg shadow-sm focus:ring-2 focus:ring-primary transition"
                value={roomId}
                onChange={(e) => setRoomId(e.target.value.replace(/\s+/g, '-').toLowerCase())}
                required
              />
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                className="bg-secondary/50 min-h-24 rounded-lg shadow-sm focus:ring-2 focus:ring-primary transition"
                value={description}
              ...
              <div className="space-y-1 relative">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="startTime"
                    type="datetime-local"
                    className="bg-secondary/50 rounded-lg shadow-md w-full pl-10 py-2 focus:ring-2 focus:ring-primary hover:shadow-lg transition-all cursor-pointer"
                    value={startTime}
                    onChange={(e) => setStartTime(e.target.value)}
                    required={isScheduled}
                  />
                </div>
                <p className="text-xs text-muted-foreground">Pick a date & time for the exam</p>
              </div>


            {/* Max Students */}
            <div className="space-y-1">
              <Label htmlFor="maxStudents" className="flex items-center gap-2 font-medium">
            ...
            {/* Room Password */}
            <div className="space-y-1">
              <Label htmlFor="roomPassword" className="flex items-center gap-2 font-medium">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="bg-secondary/50 flex-1 rounded-lg shadow-sm focus:ring-2 focus:ring-primary transition"
                  value={roomPassword}
                ...
                <Button 
                  ...
                  variant="outline"
                  className="border border-gray-300 hover:border-primary"
                >
                  Generate
                </Button>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
              <Button
                type="submit"
                className="w-full sm:w-48 h-12 text-sm font-semibold rounded-lg bg-black text-white hover:bg-gray-800 transition-all"
                disabled={isLoading}
              >
                {isLoading 
...
//       const response = await axios.post('https://codeguard-server-side-1.onrender.com/api/rooms', {
//         roomId: roomId.replace(/\s+/g, '-').toLowerCase(),
//         password: roomPassword,
//         examName: examName,
//         courseName: examName,
